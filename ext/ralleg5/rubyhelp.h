...
#define RBH_BOOL_INT(VAL) (((VAL) == Qnil) || ((VAL) == Qfalse) ? 0 : (!0))
...
// Macro to define module singleton methods
#define RBH_MODULE_SINGLETON_MEHOD(KLASS, NAME, VALUE) \
	rb_define_singleton_method(RBH_MODULE_VAR(KLASS), #NAME, FUNC, ARITY)
